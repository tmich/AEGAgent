...
import it.aeg2000srl.aegagent.mvp.IView;

/**
 * Created by tiziano.michelessi on 28/09/2015.
 */
public class DownloadCustomersService extends AsyncTask<String, Integer, Integer> {
    ...
    public DownloadCustomersService(IUpdateDataView view) {
        _view = view;
